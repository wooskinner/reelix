...
const ROW_CONFIG = [
  { id: 'trending-list', emoji: '🔥', title: 'Trending Now', genreKey: null,
    url: `${API}/trending/movie/week?api_key=${API_KEY}`, type: 'movie', style: 'landscape', showRank: true },
  { id: 'top-list', emoji: '⭐', title: 'Popular on Reelix', genreKey: null,
  ...
  { id: 'tv-list', emoji: '📺', title: 'TV Shows', genreKey: null,
  ...
  { id: 'horror-list', emoji: '👻', title: 'Horror Movies', genreKey: 27,
  ...
  { id: 'comedy-list', emoji: '😂', title: 'Comedies', genreKey: 35,
  ...
  { id: 'romance-list', emoji: '💕', title: 'Romantic Movies', genreKey: 10749,
  ...
  { id: 'animation-list', emoji: '🎨', title: 'Animated Movies', genreKey: 16,
