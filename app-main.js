...
const ROW_CONFIG = [
  ...
  { id: 'documentary-list', emoji: '🎥', title: 'Documentary', genreKey: 99,
    url: `${API}/discover/movie?api_key=${API_KEY}&with_genres=99&sort_by=popularity.desc`, type: 'movie', style: 'landscape' },
  { id: 'featured-list', emoji: '✨', title: 'Staff Picks', genreKey: null,
